    ...
    <div class="modal-dialog" role="document" >
        <div class="modal-content">
            ...
            <div class="modal-footer">
                    @if(Auth::check())
                    <form action="http://127.0.0.1:8000/enviar_comentario" method="POST" id="end_collapse">
                    @csrf
                   ...
                   @else
                   Entre com sua conta para enviar um comentario     <a href="{{ route('login') }}" class="btn btn-primary ">Entrar</a>
                   @endif
            </div>
        </div>
    </div>
