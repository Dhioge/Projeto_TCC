...
@endcomponent
            ...
            //funcao para inserir as notificacoes
            function notificacoes(){                
            $.getJSON( "http://127.0.0.1:8000/notificacoes", function( data ) {
              $.each( data, function( key, val ) {
                var items = [];
                var modal = 'nenhum'
                if(val['tipo']=='alteracao_produto'){
                    
                    modal = 'alterar_produto'
                    }else{
                    modal = 'mensagem'
                    }
            ...
            function timeout() {
                //apaga notificacoes
                $(".drop-itens").empty();
                //define tempo para renovar as notificacoes
                setTimeout(function () {
                    timeout();
                    notificacoes()
            ...
            <li class="nav-item">
                <a class="nav-link my-1 my-lg-1 mr-lg-2" style="margin-left:50px" data-toggle="modal" data-target="#exampleModal" >
